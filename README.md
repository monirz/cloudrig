...
**GKE** — `CreateCluster` starts a *real* local Kubernetes, not a stub:
`kubectl` against it schedules real pods. It prefers k3s (via k3d) and falls
back to kind; either needs a container runtime.
